...
This repository's coding standards live in `.github/instructions/` and `.github/copilot-instructions.md`. Key expectations:

- Comment intent and decisions (**why**), not mechanics (**what**), and remove stale/paraphrased comments.
- Add TSDoc/JSDoc to every exported function in `db/` and `src/lib/`, including `@param` and `@returns`.
- Document reusable Astro component `Props` interfaces so component contracts are explicit.
- Keep TypeScript formatting and hygiene aligned with ESLint.

Primary references:

- [Copilot instructions](.github/copilot-instructions.md)
- [UI strategy](.github/instructions/ui.instructions.md)
- [Astro component instructions](.github/instructions/astro.instructions.md)
- [Drizzle data-layer instructions](.github/instructions/drizzle.instructions.md)
